...
def test_protocol_satisfied_by_duck_typed_class() -> None:
    ...
    class FakeBackend:
        def init(self) -> None: ...
        def snapshots(self, tags=None): return []
        def ls(self, snapshot_id: str): return []
        def check_sentinels(self, snapshot_id: str, sentinels: list) -> bool: return True
        def snapshot_size(self, snapshot_id: str): return 0
